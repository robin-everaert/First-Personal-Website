...
<header id="main-header">
    ...
    <div class="sitebar flex-row">
        <span>Everaert Robin</span>
        <span>06-14-29-78-81</span>
        <span>r-everaert@outlook.fr</span>
        <span>04800 Greoux Les Bains</span>  
    </div>

    <div class="header-content flex-col font-aldrich">

        <div  class="logo"> 
            <svg aria-label="Le logo de Everaert Robin Développeur Web Freelance" viewBox="0 0 600.000000 600.000000" preserveAspectRatio="xMidYMid meet"  width="150" height="200"  >
                <g fill="var(--main)"  transform="translate(0.000000,600.000000) scale(0.100000,-0.100000)"
                stroke="none">
    ...
    <nav class="main-nav font-aldrich">
        <ul class="flex-row">
            <li>
                <a href="index.php?p=accueil">Accueil</a>
            </li>
            <li>
                <a href="index.php?p=service">Service</a>
            </li>
            <li>
